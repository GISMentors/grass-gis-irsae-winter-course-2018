...
.. figure:: ../images/units/19/sentinel_mapset.png
	:class: small
...
.. figure:: ../images/units/19/add_rgb.png

The result appears really dark

.. figure:: ../images/units/19/rgb_dark.png
...
.. figure:: ../images/units/19/icolorsenhance.png
    :class: small

The result is an enhanced image, to see it just click on :item:`Render Map`

.. figure:: ../images/units/19/rgb_good.png
