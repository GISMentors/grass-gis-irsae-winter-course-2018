Unit 33 - PyWPS LST region zones
================================

The last (fourth) version of the process will return for input region
and dates, LST zones in vector format (:wikipedia-en:`GML`), see line
...
http://localhost:5000/wps?request=Execute&service=WPS&identifier=modis-v4&version=1.0.0&datainputs=start=2017-03-01;end=2017-04-01;region=@xlink:href=http://localhost:5000/static/data/study_area.gpkg

Compare with (output return as reference):

http://localhost:5000/wps?request=Execute&service=WPS&identifier=modis-v4&version=1.0.0&datainputs=start=2017-03-01;end=2017-04-01;region=@xlink:href=http://localhost:5000/static/data/study_area.gpkg&responsedocument=zones=@asReference=true
