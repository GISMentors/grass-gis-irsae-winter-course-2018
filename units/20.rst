...
.. code-block:: bash
   ...
   i.modis.download settings=settings.txt folder=geodata/modis \
...
Data will be imported including reprojection into target location.
...
.. todo:: Fig. above: Norway should be clipped. Mask is missing.
