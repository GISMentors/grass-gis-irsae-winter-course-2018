...
new location based on Norway administrative borders
:file:`Basisdata_0000_Norge_25833_Fylker_GML.gml` data file from
sample dataset.
...
file (here UTM zone 33N :epsg:`25833`).
...
optionally import input data.

.. note:: Unfortunately Location Wizard has problem with importing
          vector data with more layers (which is our case). We will
          skip this operation since we are going to import input data
          later by more advanced GRASS importer.
