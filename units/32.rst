Unit 32 - PyWPS LST region stats
================================
...
Copy :file:`study_area.gpkg` to :file:`pywps-flask/static/data` and
execute the process.

http://localhost:5000/wps?request=Execute&service=WPS&identifier=modis-v3&version=1.0.0&datainputs=start=2017-03-01;end=2017-04-01;region=@xlink:href=http://localhost:5000/static/data/study_area.gpkg
